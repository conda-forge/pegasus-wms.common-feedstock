...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pegasus-wms.common-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11458&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pegasus-wms.common-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pegasus-wms.common` can be installed with:

```
conda install pegasus-wms.common
```

It is possible to list all of the versions of `pegasus-wms.common` available on your platform with:
